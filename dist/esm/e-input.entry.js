...
const EInput = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: this.classes() }, h("slot", { name: "prepend-icon" }, this.renderIcon(this.prependIcon)), h("input", { placeholder: this.placeholder, value: this.value }), h("slot", { name: "append-icon" }, this.renderIcon(this.appendIcon)))));
    }
};
