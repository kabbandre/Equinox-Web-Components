...
const ECheckbox = class {
    ...
    render() {
        return (h("label", { class: this.classes() }, h("slot", null, "Eclipse"), h("input", { type: "checkbox" }), h("span", { class: "checkmark" })));
    }
};
